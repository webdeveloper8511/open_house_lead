...
@section('content')
        ...
        <div class="container-fluid  m-auto text-center shadow p-3 rounded accordion-flush">
            <h2 class="mb-3">Edit Agent</h2>
                <div class="row mb-3 align-items-end">
                    <div class="col-6 text-left">
                        <a class="btn btn-primary" href="{{Route('your-team')}}">Manage Your Team</a>
                    </div>
                    <div class="col-6 text-end">
                    <td><a class="btn btn-primary" href="#" onclick="document.getElementById('id01').style.display='block'"><i class="fas fa-trash-alt"></i> Remove </a></td>
                    </div>
                </div>
                <form action="">
                    <div class="row mb-3">
                        <div class="form-group col-6">
                            ...
                            <input type="text" id="Team Name" name="Team Name" placeholder="Team Name" value="Robert Mareno's Team" required="">
                        </div>
                        <div class="form-group col-6">
                            <label class="text-left" for="Robert Mareno">Agent Name</label>
                            <input type="text" id="OPEN_Robert MarenoHOUSE" name="Robert Mareno" placeholder="Agent Name" value="Robert Mareno" required="">
                        </div>
                    </div>
                    <div class="mx-auto text-center">
                    <a class="btn btn-primary" href="{{Route('your-team')}}"><h5 class="mb-0">Save</h5></a>
                    </div>
                </form>
            </div>
        </section>
    ...
    <div id="id01" class="modal">
      ...
      <form class="modal-content" action="/action_page.php">
        <div class="container py-4 px-3 text-center">
          <h3><b>Delete This Agent?</b></h3>
          <h6 class="mb-3"><b>Are You Sure You Want To Delete This Agent?</b></h6>
          <div class="clearfix">
