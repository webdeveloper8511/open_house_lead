...
@section('content')
    <section class="property-page-section d-flex h-100vh p-4 bg-black-50">
        ...
        <div class="row justify-content-between p-3">
            ...
            <h2 class="mb-2">ALL Visitors and/or Leads.</h2>
            <h5 class="mb-2">Use The <a href="{{route('property')}}">Properties page to View Visitors by Property.</a></h5>
            </div>
            ...
            <div class="overflow-Scroll">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <th>09/19/23</th>
                        <td>Test Test</td>
                        <td>Jfwoei@gjdj.com</td>
                        <td>374-839-3844</td>
                        <td>No</td>
                        <td><a class="btn btn-primary" href="{{Route('visitor-view')}}" data-toggle="tooltip" title="View"><i class="far fa-eye"></i> View</a></td>
                        <td><a class="btn btn-primary" href="{{route('visitor-add-edit')}}" data-toggle="tooltip" title="Edit"><i class="fas fa-edit"></i> Edit</a></td>
                        <td><a class="btn btn-primary" href="#" data-toggle="tooltip" title="Remove"><i class="fas fa-trash-alt"></i> Remove</td>
                    </tr>
                    </tbody>
                </table>
            </div>
